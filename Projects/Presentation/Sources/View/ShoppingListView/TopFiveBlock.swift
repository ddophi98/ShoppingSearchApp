...
final public class TopFiveBlock: UITableViewCell {
    ...
    lazy private var collectionView: UICollectionView = {
        let collectionViewFlowLayout: UICollectionViewFlowLayout = {
            ...
            layout.itemSize = .init(width: TopFiveCell.cellWidth, height: TopFiveCell.cellHeight)
            return layout
        }()
        ...
        collectionView.register(TopFiveCell.self, forCellWithReuseIdentifier: TopFiveCell.id)
